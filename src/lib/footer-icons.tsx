...
// Re-export lucide icons needed for the footer
export { Blocks, CodeXml, CreditCard, Handshake, Scale, Webhook };

// Define custom SVG Icon components
export const PlausibleIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      strokeWidth="2" // Use kebab-case
      d="M4 8.5V23c3 0 6-3 6-5.5h2.5c4 0 7.5-4 7.5-9 0-3-3-7.5-8-7.5S4 5.5 4 8.5Z"
    />
  </svg>
);

export const MatomoIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
  >
    <path
      strokeMiterlimit="1.4" // Use kebab-case
      strokeWidth="2" // Use kebab-case
...
export const GoogleAnalyticsIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
